...
function ProductList() {
  ...
  const cartSize = useSelector((state) => state.cart.items).reduce(
  ...
  return (
    <div>
        ...
        <div style={styleObjUl}>
          ...
          <div>
            ...
            <a href="#" onClick={(e) => handleCartClick(e)} style={styleA}>
              <div class="cart">
                <div class="cart_quantity_count">{cartSize}</div>
                <svg
      ...
      {!showCart ? (
        ...
        <CartItem onContinueShopping={handleContinueShopping} onRemove={removeFromCart}/>
      )}
    </div>
  );
}
